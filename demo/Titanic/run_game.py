...
atlantic_area = AreaOnGrid(
    LocationOnGrid(latitude=35, longitude=-1.41),
    LocationOnGrid(latitude=65, longitude=-74))
...
def run_game(map_animation, journey, tio: TitanicInOcean, atlantic_area):
    ...
    def main_game_loop(stdscr):
        ...
        stdscr.addstr(
            0, 0,
            "Q=Quit. 0=Stop Titanic. WASD-controls (WS control speed, AD control rotation, no need to press and hold)"
        )

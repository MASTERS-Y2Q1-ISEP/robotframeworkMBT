...
Vertex Scenario-Delta-Value graph
    ...
    And graph g contains vertex 'A1' with text "states = ['a1'], special='!'"
    And graph g contains vertex 'A2' with text "states = ['a1', 'a2']"
    And graph g does not contain vertex 'A2' with text "states = ['a1', 'a2'], special='!'"